    ...
    <div className="min-h-screen bg-gradient-to-b from-emerald-50 via-white to-sky-50">
        ...
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <Link to="/reading-recovery" className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground">{rr.byDebs}</p>
            </div>
          </Link>
      ...
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            >
              {isEnrolled ? rr.continueJourney : rr.startFreeAssessment}
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12">{rr.howItWorksTitle}</h2>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              { step: 1, title: rr.step1Title, desc: rr.step1Desc, icon: Users },
              { step: 2, title: rr.step2Title, desc: rr.step2Desc, icon: Target },
              { step: 3, title: rr.step3Title, desc: rr.step3Desc, icon: FileText },
              { step: 4, title: rr.step4Title, desc: rr.step4Desc, icon: TrendingUp },
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12">{rr.whatsIncludedTitle}</h2>
      ...
      <section className="py-16 bg-emerald-900 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-12">{rr.outcomesTitle}</h2>
          <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            {[
              { icon: Target, title: rr.outcome1Title, desc: rr.outcome1Desc },
              { icon: TrendingUp, title: rr.outcome2Title, desc: rr.outcome2Desc },
              { icon: Award, title: rr.outcome3Title, desc: rr.outcome3Desc },
      ...
      <section className="py-16">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-4">{rr.readyToStart}</h2>
          ...
          <Button 
            ...
            onClick={handleAccessProgramme}
          >
            {isEnrolled ? rr.goToDashboard : rr.createFreeAccount}
            <ArrowRight className="ml-2 w-5 h-5" />
          </Button>
      ...
      <section className="py-8 bg-muted/30 border-t">
        <div className="container mx-auto px-4 text-center">
          <p className="text-sm text-muted-foreground">
            {rr.lookingForDiagnostics}{" "}
            <Link to="/" className="text-primary hover:underline font-medium">
              {rr.visitDiagnosticHub}
            </Link>
          </p>
        </div>
      </section>
