...
export default function TakeELATest() {
  ...
  const mapTopicToSection = (topic: string, qType: string): string => {
    ...
    if (t.includes("reading") || t.includes("comprehension") || t.includes("main idea") || t.includes("inference") || t.includes("summary") || t.includes("author") || t.includes("passage") || t.includes("text structure") || t.includes("central idea") || t.includes("literary") || t.includes("rhetoric") || t.includes("theme") || t.includes("character") || t.includes("plot") || t.includes("setting") || t.includes("point of view") || t.includes("compare") || t.includes("text evidence") || t.includes("supporting detail") || t.includes("cause and effect") || t.includes("sequence") || t.includes("story element") || t.includes("genre")) return "Reading Comprehension";
    // Vocabulary
    if (t.includes("vocab") || t.includes("synonym") || t.includes("antonym") || t.includes("context clue") || t.includes("word meaning") || t.includes("word structure") || t.includes("prefix") || t.includes("suffix") || t.includes("root") || t.includes("figurative") || t.includes("idiom") || t.includes("connotation") || t.includes("denotation") || t.includes("compound word") || t.includes("multiple meaning") || t.includes("word choice") || t.includes("word relationship")) return "Vocabulary";
    // Spelling
    if (t.includes("spell") || t.includes("homophone") || t.includes("homograph") || t.includes("phonics") || t.includes("phoneme") || t.includes("syllable") || t.includes("word pattern")) return "Spelling";
    // Grammar & Language Conventions
    if (t.includes("grammar") || t.includes("punctuation") || t.includes("verb") || t.includes("subject") || t.includes("pronoun") || t.includes("adjective") || t.includes("adverb") || t.includes("sentence") || t.includes("clause") || t.includes("conjunction") || t.includes("tense") || t.includes("agreement") || t.includes("capitalization") || t.includes("comma") || t.includes("apostrophe") || t.includes("possessive") || t.includes("parts of speech") || t.includes("modifier") || t.includes("preposition") || t.includes("contraction") || t.includes("plural") || t.includes("noun") || t.includes("article")) return "Grammar & Language Conventions";
    // Writing
    if (t.includes("writ") || t.includes("essay") || t.includes("narrative") || t.includes("opinion") || t.includes("persuasive") || t.includes("argument") || t.includes("composition") || t.includes("paragraph") || t.includes("descriptive") || t.includes("procedural") || t.includes("prompt")) return "Writing";
